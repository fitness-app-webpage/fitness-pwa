...
router.setRoutes([
    ...
    {path: `${BASE}/product/:product`, name: "Product", component: 'product-page', action: changeTitleAndAuthCheck},
    {path: `${BASE}/products/:mealtype`, name: "Products", component: 'products-page', action: changeTitleAndAuthCheck},
    {path: `${BASE}/product/:mealtype/:product`, name: "Product", component: 'product-page', action: changeTitleAndAuthCheck},
    {path: `${BASE}/scan/product/:mealtype`, name: "Scan barcode", component: 'scan-page', action: changeTitleAndAuthCheck},
